...
var x__26406__auto__ = (((x == null))?null:x);
var m__26407__auto__ = (sablono.util.to_str[goog.typeOf(x__26406__auto__)]);
if(!((m__26407__auto__ == null))){
return m__26407__auto__.call(null,x);
} else {
var m__26407__auto____$1 = (sablono.util.to_str["_"]);
if(!((m__26407__auto____$1 == null))){
return m__26407__auto____$1.call(null,x);
} else {
...
var x__26406__auto__ = (((x == null))?null:x);
var m__26407__auto__ = (sablono.util.to_uri[goog.typeOf(x__26406__auto__)]);
if(!((m__26407__auto__ == null))){
return m__26407__auto__.call(null,x);
} else {
var m__26407__auto____$1 = (sablono.util.to_uri["_"]);
if(!((m__26407__auto____$1 == null))){
return m__26407__auto____$1.call(null,x);
} else {
...
var len__26809__auto___30728 = arguments.length;
var i__26810__auto___30729 = (0);
while(true){
if((i__26810__auto___30729 < len__26809__auto___30728)){
args__26816__auto__.push((arguments[i__26810__auto___30729]));

var G__30730 = (i__26810__auto___30729 + (1));
i__26810__auto___30729 = G__30730;
continue;
} else {
}
break;
...
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(argseq__26817__auto__);
});
...
sablono.util.as_str.cljs$lang$applyTo = (function (seq30727){
return sablono.util.as_str.cljs$core$IFn$_invoke$arity$variadic(cljs.core.seq.call(null,seq30727));
});
/**
...
var vec__30732 = clojure.string.split.call(null,cljs.core.name.call(null,k),/-/);
var first_word = cljs.core.nth.call(null,vec__30732,(0),null);
var words = cljs.core.nthnext.call(null,vec__30732,(1));
...
var G__30734 = clojure.set.rename_keys.call(null,m,kmap);
var G__30734__$1 = ((cljs.core.map_QMARK_.call(null,new cljs.core.Keyword(null,"style","style",-496642736).cljs$core$IFn$_invoke$arity$1(m)))?cljs.core.update_in.call(null,G__30734,new cljs.core.PersistentVector(null, 1, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Keyword(null,"style","style",-496642736)], null),sablono$util$camel_case_keys):G__30734);
return G__30734__$1;
} else {
return m;
}
...
var x__$1 = this;
if(cljs.core.truth_((function (){var or__25751__auto__ = x__$1.hasDomain();
